...
def get_mscoco(dataset_root, batch_size, train):
    ...
    if train:
        ...
        mscoco_dataset = datasets.ImageFolder(root=os.path.join(dataset_root, 'uda_data/mscoco/train'),
        ...
        mscoco_dataset = datasets.ImageFolder(root=os.path.join(dataset_root, 'uda_data/mscoco/val'),
                                            transform=pre_process)
